...
- (void)awakeFromNib {
    ...
    // barney has a reference to fred, and so can message fred to set itself as fred's delegate
...
- (void)dealloc {
    ...
    // release fred. Note if someone else is still retaining him he will stay alive
